...
export const categoryIcons: Record<string, string> = {
    ...
    // Slugs das categorias (usado na página de categorias)
    'music': '/images/icons/Activities Blueprint/Music and Entertainment _ electric guitar, music, rock and roll, music instrument, Vector illustration.png',
    ...
    'charity-causes': '/images/icons/Activities Blueprint/Support and Maintenance _ helping hand, assistance, guidance, support, Vector illustration.png',
    'family-kids': '/images/icons/Activities Blueprint/Family and Children _ toy gun, water gun, plastic gun, kids toy, Vector illustration.png',
    'travel-adventure': '/images/icons/Activities Blueprint/Travel and Adventure _ beach umbrella, summer vacation, beach leisure, Vector illustration.png',
    'gaming-entertainment': '/images/icons/Activities Blueprint/Gaming Industry _ game controller, video games, gaming, joystick, Vector illustration.png',
    'outdoor-nature': '/images/icons/Activities Blueprint/Travel and Adventure _ hiking, mountain climbing, adventure, backpacking, Vector illustration.png',
    'creative-design': '/images/icons/Activities Blueprint/Creative Design _ writing hand, pen, stylized, creativity, Vector illustration.png',
    'relationships-dating': '/images/icons/Activities Blueprint/Relationships _ tea set, love message, teapot, tea cup, romance.png'
};
